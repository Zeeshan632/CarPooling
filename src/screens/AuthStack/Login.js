  ...
  const Login = ({navigation, route}) => {
    ...
    const readCreds = async () => {
      try {
        ...
        setForm({...form, email: theRememberedCreds.email, password: theRememberedCreds.password})
      ...
      <View style={{flex: 1, backgroundColor: '#F5F5F5'}}>
        <ScrollView style={{flexGrow: 1}}>
          ...
          <View
            ...
            <BtnComp
              btnText={loading ? <ActivityIndicator size={25} color={'white'} /> : 'Login'}
          ...
          <View
            ...
            <Text style={{color: '#7A86A1', fontSize: hp('2%')}}>Don't have an account?  </Text>
            <TouchableOpacity onPress={() => navigation.navigate('Signup')} activeOpacity={0.5} style={{borderBottomWidth: 1, borderBottomColor: colors.themeBlue}}>
              <Text style={{fontSize: hp('2%'), color: colors.themeBlue, fontWeight: 'bold'}}>Register</Text>
            </TouchableOpacity>
          </View>
